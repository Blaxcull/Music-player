    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          className="w-full h-1.5 rounded-full bg-gray-700 cursor-pointer appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
        />
      </div>
    </div>
  );
